...
$paginaHTML = new Template("Aggiungi evento","Pagina da amministratore per aggiunta di un gioco", "sviluppatore, aggiungi, articolo, vapor", "html/aggiungi_evento.html");
